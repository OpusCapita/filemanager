...
import FileSaveConfirmDialog from '.'; // eslint-disable-line

describe('<FileSaveConfirmDialog />', () => {
  /* Recommended test-cases

  it('should have default props', () => {
    let component = <FileSaveConfirmDialog />;
  ...
  it('should have the right class name', () => {
    let wrapper = shallow(<FileSaveConfirmDialog className="test-class-name" />);
