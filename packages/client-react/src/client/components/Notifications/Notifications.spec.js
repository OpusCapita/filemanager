...
import Notifications from '.'; // eslint-disable-line
...
describe('<Notifications />', () => {
  ...
  it('should have the right class name', () => {
    let wrapper = shallow(<Notifications className="test-class-name" />);
    expect(wrapper).to.have.className('notifications');
