...
import LoadingCell from '.'; // eslint-disable-line

describe('<LoadingCell />', () => {
  /* Recommended test-cases

  it('should have default props', () => {
    let component = <LoadingCell />;
  ...
  it('should have the right class name', () => {
    let wrapper = shallow(<LoadingCell className="test-class-name" />);
    expect(wrapper).to.have.className('loading-cell');
